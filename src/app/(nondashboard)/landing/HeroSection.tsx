      ...
      <div className="absolute inset-0 flex items-center justify-center z-20">
        ...
        >
          ...
          >
            ...
            {/* Compact Search Bar */}
            <div className="max-w-5xl mx-auto bg-white dark:bg-gray-800 rounded-full shadow-lg overflow-hidden mb-4 w-full p-2">
              <div className="flex flex-col md:flex-row items-center gap-2">
                ...
                <div className="w-full md:w-auto px-2">
                  <Button 
                    className="w-full bg-[#00acee] hover:bg-[#0099d4] text-white  rounded-full px-4 py-2 text-sm"
